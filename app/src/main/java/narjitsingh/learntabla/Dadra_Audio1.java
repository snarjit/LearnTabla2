 ...
 */
public class Dadra_Audio1 extends AppCompatActivity {
    ImageButton slow;
    ImageButton medium;
    ImageButton fast;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dadra0);
        // getting slow button play and stop
        slow = (ImageButton) findViewById(R.id.dadra0_audio_slow);

//getting medium button play and stop
        medium = (ImageButton) findViewById(R.id.dadra0_audio_medium);

        //getting fast button play and stop
        fast = (ImageButton) findViewById(R.id.dadra0_audio_fast);
        fastStop = (ImageButton) findViewById(R.id.dadra0_audio_stop);
    ...
    public void onBackPressed() {
        stopPlaying();
        Intent back = new Intent(getApplicationContext(), Dadra_Taal_ListView.class);
        startActivity(back);
