 ...
 */
public class Kehrwa_Audio13 extends AppCompatActivity {
    ImageButton slow;
    ImageButton medium;
    ImageButton fast;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kehrwa13);
        // getting slow button play and stop
        slow = (ImageButton) findViewById(R.id.kehrwa13_audio_slow);

//getting medium button play and stop
        medium = (ImageButton) findViewById(R.id.kehrwa13_audio_medium);

        //getting fast button play and stop
        fast = (ImageButton) findViewById(R.id.kehrwa13_audio_fast);
        fastStop = (ImageButton) findViewById(R.id.kehrwa13_audio_stop);
    ...
    public void onBackPressed() {
        stopPlaying();
        Intent back = new Intent(getApplicationContext(), ListView_Kehrwa.class);
        startActivity(back);
