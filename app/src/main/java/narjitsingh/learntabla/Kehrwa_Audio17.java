 ...
 */
public class Kehrwa_Audio17 extends AppCompatActivity {
    ImageButton slow;
    ImageButton medium;
    ImageButton fast;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kehrwa17);
        // getting slow button play and stop
        slow = (ImageButton) findViewById(R.id.kehrwa17_audio_slow);

//getting medium button play and stop
        medium = (ImageButton) findViewById(R.id.kehrwa17_audio_medium);

        //getting fast button play and stop
        fast = (ImageButton) findViewById(R.id.kehrwa17_audio_fast);
        fastStop = (ImageButton) findViewById(R.id.kehrwa17_audio_stop);
