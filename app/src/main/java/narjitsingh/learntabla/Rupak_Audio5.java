 ...
 */
public class Rupak_Audio5 extends AppCompatActivity {
    ImageButton slow;
    ImageButton medium;
    ImageButton fast;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        slow = (ImageButton) findViewById(R.id.rupak5_audio_slow);

//getting medium button play and stop
        medium = (ImageButton) findViewById(R.id.rupak5_audio_medium);

        //getting fast button play and stop
        fast = (ImageButton) findViewById(R.id.rupak5_audio_fast);
        fastStop = (ImageButton) findViewById(R.id.rupak5_audio_stop);
