 ...
 */
public class Teentaal_Audio4 extends AppCompatActivity {
    ImageButton slow;
    ImageButton medium;
    ImageButton fast;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teentaal4);
        // getting slow button play and stop
        slow = (ImageButton) findViewById(R.id.teentaal4_audio_slow);

//getting medium button play and stop
        medium = (ImageButton) findViewById(R.id.teentaal4_audio_medium);

        //getting fast button play and stop
        fast = (ImageButton) findViewById(R.id.teentaal4_audio_fast);
        fastStop = (ImageButton) findViewById(R.id.teentaal4_audio_stop);
