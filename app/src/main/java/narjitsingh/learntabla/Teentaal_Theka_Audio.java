...
/**
 * Created by SurnarSingh on 8/15/16.
 */
public class Teentaal_Theka_Audio extends AppCompatActivity {
    ImageButton slow;
    ImageButton medium;
    ImageButton fast;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teentaal_theka_audio);
        // getting slow button play and stop
        slow = (ImageButton) findViewById(R.id.teentaal_audio_slow);

//getting medium button play and stop
        medium = (ImageButton) findViewById(R.id.teentaal_audio_medium);

        //getting fast button play and stop
        fast = (ImageButton) findViewById(R.id.teentaal_audio_fast);
        fastStop = (ImageButton) findViewById(R.id.teentaal_audio_stop);
